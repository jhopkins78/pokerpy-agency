...
def init_websocket_handlers(socketio: SocketIO, agent_orchestrator=None, rag_orchestrator=None):
    """Initialize WebSocket handlers with orchestrators"""
    chat_handler = ChatHandler(socketio)
    
    # Store orchestrators for enhanced functionality
    if agent_orchestrator:
        chat_handler.agent_orchestrator = agent_orchestrator
    if rag_orchestrator:
